          ...
          >
            ...
            <div className="flex items-center justify-between border-b border-neutral-100 px-6 py-4 bg-neutral-50/80">
              <div className="flex items-center space-x-2.5">
                <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-red text-white shadow-2xs">
                  <MapPin className="h-5 w-5" />
                </div>
                <div>
                  <h3 className="text-base font-bold text-neutral-900">Select Your Outlet</h3>
                  <p className="text-xs text-neutral-500 font-normal">Pick nearest branch for takeaway or fast delivery</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            {/* List */}
            <div className="max-h-[60vh] overflow-y-auto p-4 sm:p-6 space-y-2.5">
              {INITIAL_BRANCHES.map((branch) => {
                ...
                return (
                  <div
                    ...
                    className={`group cursor-pointer rounded-2xl p-4 transition-all duration-150 border ${
                      isSelected
                        ? 'border-brand-red bg-red-50/50 shadow-xs'
                    ...
                    <div className="flex items-start justify-between">
                      <div className="space-y-1">
                        <div className="flex items-center space-x-2">
                          <h4 className="font-bold text-sm text-neutral-900 group-hover:text-brand-red transition-colors">
                            {branch.name}
                          </h4>
                        ...
                        <p className="text-xs text-neutral-600 leading-relaxed font-normal">{branch.address}</p>
            ...
            <div className="border-t border-neutral-100 px-6 py-3.5 bg-neutral-50 flex items-center justify-between text-xs text-neutral-500">
              <span>Looking for corporate catering?</span>
