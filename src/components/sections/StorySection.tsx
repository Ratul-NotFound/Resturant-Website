...
export function StorySection() {
  return (
    <section id="story" className="relative py-24 sm:py-32 bg-obsidian-900 overflow-hidden text-neutral-300">
      
      {/* Background Accent Gradients */}
      <div className="absolute top-1/3 right-0 w-96 h-96 bg-[radial-gradient(circle,rgba(212,175,55,0.06),transparent_70%)] pointer-events-none" />
      <div className="absolute bottom-10 left-0 w-96 h-96 bg-[radial-gradient(circle,rgba(212,175,55,0.04),transparent_70%)] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-gold-primary/10 border border-gold-primary/30 text-gold-light text-xs font-semibold uppercase tracking-widest mb-3">
            <Sparkles className="h-3.5 w-3.5 text-gold-primary" /> The Philosophy & Heritage
          </div>
          <h2 className="font-serif text-3xl sm:text-5xl font-bold text-champagne mb-4 tracking-tight">
            Where Fire, Foraged Luxury & Architecture Converge
          </h2>
          <p className="text-xs sm:text-sm text-neutral-400 leading-relaxed font-sans">
            Founded by Chef Gabriel Moreau, AURA was conceived not merely as a restaurant, but as a temple dedicated to the absolute limits of sensory delight.
          </p>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center mb-20">
          ...
          <div className="lg:col-span-6 relative">
            ...
            {/* Floating Floating Milestone Badge */}
            <div className="absolute -bottom-6 -right-4 sm:bottom-6 sm:-right-6 p-5 rounded-2xl bg-obsidian-950/95 border border-gold-primary/40 backdrop-blur-xl shadow-2xl max-w-xs">
              ...
              <p className="text-[11px] text-neutral-400 leading-relaxed">
                Awarded the Michelin Guide’s highest distinction for 5 consecutive years.
              </p>
            </div>
          </div>
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            <div className="grid sm:grid-cols-3 gap-4 pt-4 border-t border-neutral-800">
              <div className="p-4 rounded-xl bg-obsidian-950 border border-neutral-800">
                ...
                <span className="text-[10px] text-neutral-400 mt-1 block">Direct farm partnerships</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-obsidian-950 border border-neutral-800">
                ...
                <span className="text-[10px] text-neutral-400 mt-1 block">Zero chemical flame</span>
              </div>
              ...
              <div className="p-4 rounded-xl bg-obsidian-950 border border-neutral-800">
                ...
                <span className="text-[10px] text-neutral-400 mt-1 block">Curated by Master Sommeliers</span>
              </div>
            </div>
          </div>
        </div>
