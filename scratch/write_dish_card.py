        ...
        <div className="space-y-2.5 pt-1 border-t border-neutral-100">
            ...
            {item.portions.map((portion) => {
              ...
              return (
                <button
                  ...
                  type="button"
                  className={elative flex-1 py-1.5 px-1.5 rounded-xl text-[11px] sm:text-xs font-bold transition-all duration-200 text-center flex items-center justify-center gap-1 }
                >
                  {isSelected && (
                    <motion.div
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              type="button"
              className={lex-1 py-2.5 px-4 rounded-2xl text-xs font-bold transition-all duration-200 shadow-sm flex items-center justify-center gap-1.5 active:scale-95 }
            >
              {added ? (
                <>
